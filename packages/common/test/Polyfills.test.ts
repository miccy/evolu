...
describe.each(disposableStackImpls)("DisposableStack ($name)", ({
	Stack,
	disposeSymbol,
}) => {
	...
	describe("disposed", () => {
		...
		it("has a prototype accessor", () => {
			...
			const desc = Object.getOwnPropertyDescriptor(Stack.prototype, "disposed");
...
describe.each(asyncDisposableStackImpls)("AsyncDisposableStack ($name)", ({
	Stack,
	disposeSymbol,
	syncDisposeSymbol,
}) => {
	...
	describe("Symbol.asyncDispose", () => {
		it("is the same function as disposeAsync", () => {
			expect(Stack.prototype[disposeSymbol]).toBe(Stack.prototype.disposeAsync);
		});
	});
